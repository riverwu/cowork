...
Modern SaaS pitch decks, demo days, product launches, growth marketing keynote slides. Anywhere the deck has to read confident, contemporary, and momentum-led. Bright purple-coral-teal palette with elevated rounded cards.

## When NOT to use

Enterprise board reports, scholarly papers, heritage / luxury brands, anything that should feel restrained or print-like — try `editorial-paper`, `midnight-executive`, or `academic-paper` instead.
