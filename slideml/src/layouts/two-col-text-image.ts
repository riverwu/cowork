...
export const slots: Record<string, SlotSchema> = {
  ...
  // text capacity scales with `density` (loose ~110/180 chars CJK/Latin,
  // normal ~225/360, dense ~450/720, micro ~750/1200). The hard maxChars
  // here is a safety ceiling at the densest setting.
