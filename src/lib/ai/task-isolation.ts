...
- Memory retrieval is disabled for this isolated run. Do not infer prior task choices from habit, old file paths, old deck names, old generated images, or old tool sequences.
