...
function authoredChartSeriesStyle(record: Record<string, unknown>, fallbackName: string): Partial<BoundChartSeries> {
  return {
    ...
    ...(record.lineDash === "solid" || record.lineDash === "dash" || record.lineDash === "dashDot" || record.lineDash === "dot" ? { lineDash: record.lineDash } : {}),
...
function chartSeriesDecorations(option: ChartSeriesOption | undefined): Partial<BoundChartSeries> {
  return {
    ...
    ...(option?.color ? { color: option.color as BoundChartSeries["color"] } : {}),
    ...(typeof option?.lineWidth === "number" ? { lineWidth: option.lineWidth } : {}),
    ...(option?.lineDash ? { lineDash: option.lineDash } : {}),
    ...(typeof option?.smooth === "boolean" ? { smooth: option.smooth } : {}),
    ...(option?.marker && typeof option.marker === "object" ? { marker: option.marker as BoundChartSeries["marker"] } : {}),
    ...(option?.dataLabels && typeof option.dataLabels === "object" ? { dataLabels: option.dataLabels as BoundChartSeries["dataLabels"] } : {}),
